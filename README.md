<svg viewBox="222 585 1065 318" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" style="max-height: 500px" width="2516" height="79.5">
  ...
  <g transform="matrix(0.3333333333333333,0,0,0.3333333333333333,124.69696969696969,332.7881524182316)">
    <svg width="750" height="125" preserveAspectRatio="xMidYMid meet" data-background-color="#ffffff" viewBox="0 0 198 33" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        <svg width="41.169838277531305" height="41.169838277531305" viewBox="0 0 41.169838277531305 41.169838277531305">
          <g>
            <svg/>
          </g>
          <g id="icon-0">
            <svg width="41.169838277531305" height="41.169838277531305" viewBox="0 0 41.169838277531305 41.169838277531305">
              <g>
                <path stroke="transparent" fill="#000000" data-fill-palette-color="accent" d="M0 20.585c0-11.368 9.216-20.585 20.585-20.585 11.368 0 20.585 9.216 20.585 20.585 0 11.368-9.216 20.585-20.585 20.585-11.368 0-20.585-9.216-20.585-20.585zM20.585 39.057c10.202 0 18.472-8.27 18.472-18.472 0-10.202-8.27-18.472-18.472-18.472-10.202 0-18.472 8.27-18.472 18.472 0 10.202 8.27 18.472 18.472 18.472z"/>
                <ellipse data-fill-palette-color="accent" fill-opacity="1" stroke-width="0" stroke="transparent" fill="#000000" cy="20.584919138765653" cx="20.584919138765653" ry="20.379069947377995" rx="20.379069947377995"/>
              </g>
              <g transform="matrix(1,0,0,1,9.10617696569071,12.40987375052341)">
                <svg width="22.957484346149885" height="16.350090776484485" viewBox="0 0 22.957484346149885 16.350090776484485">
                  <g>
                    <svg id="dxe-0" data-fill-palette-color="quaternary" class="icon-dxe-0" width="22.957484346149885" height="16.350090776484485" xml:space="preserve" viewBox="0 7.1955 100 35.6095" y="0" x="0" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                      <path data-fill-palette-color="quaternary" fill="#ffffff" d="M100 27.126S96.039 31.636 82.063 41.668C70.611 49.887 56.175 48.205 41.826 40.456 36.005 37.312 33.696 35.366 31.022 31.289 28.43 27.336 22.548 14.391 22.548 14.391S21.037 19.873 10.925 29.753C8.864 31.767 0 37.541 0 37.541L6.31 43.807S18.034 38.537 24.464 43.67C27.878 46.394 29.516 49.318 29.793 61.233 30.069 73.143 30.068 85.61 30.068 85.61H38.694L42.296 67.525S48.249 71.496 56.014 70.759C65.851 69.827 74.393 66.359 74.393 66.359S75.755 69.845 75.755 85.61H85.66S85.012 58.31 89.942 46.965C93.195 39.479 100 27.126 100 27.126"/>
                    </svg>
                  </g>
                </svg>
              </g>
...
<rect visibility="hidden" stroke="none" fill="none" height="32.5680887819772" width="197.76"/>
</g>
</svg>
</g>
</svg>
...
We propose a **Neural Watchdog**, an open-source tool for detecting the stealthy backdoor attacks Deep Reinforcement Learning policies. In this repository, we design an evasive backdoor called an "in-distribution trigger" and detect them using this tool.  

To understand the technical details of Neural Watchdog, check out our paper here:
https://arxiv.org/pdf/2407.15168
